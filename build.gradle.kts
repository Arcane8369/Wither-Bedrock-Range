...
object ModConfig {
    ...
    const val MOD_ID = "witherbedrockrange"
    const val MOD_NAME = "Wither Bedrock Range"
    const val MOD_LICENSE = "GPL-3.0"
...
// createMinecraftArtifacts consumes generateModMetadata's output; declare the
// dependency explicitly so Gradle doesn't flag it as an implicit dependency.
